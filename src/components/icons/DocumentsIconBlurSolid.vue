  ...
  >
    ...
    <defs data-testid="SvgComponent-defs">
      <linearGradient
        ...
        data-testid="SvgComponent-linearGradient"
      >
        <stop
          stop-color="#FF991F"
          data-testid="SvgComponent-stop"
          data-darkreader-inline-stopcolor=""
          style="--darkreader-inline-stopcolor: #b96500"
        ></stop>
        <stop
          offset="1"
          stop-color="#FF991F"
